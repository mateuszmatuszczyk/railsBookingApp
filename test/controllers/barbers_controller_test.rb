...
class BarbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barber" do
    assert_difference('Barber.count') do
      post barbers_url, params: { barber: { barber_bio: @barber.barber_bio, barber_name: @barber.barber_name, barber_photo_path: @barber.barber_photo_path, user_id: @barber.user_id } }
    end
  ...
  test "should update barber" do
    patch barber_url(@barber), params: { barber: { barber_bio: @barber.barber_bio, barber_name: @barber.barber_name, barber_photo_path: @barber.barber_photo_path, user_id: @barber.user_id } }
